        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicalFindings = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Medications = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PatientId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllergyHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AllergyHistories_Patients_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LabRecords_MedicalRecords_MedicalRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllergyHistories_PatientId",
                table: "AllergyHistories",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_LabRecords_MedicalRecordId",
                table: "LabRecords",
